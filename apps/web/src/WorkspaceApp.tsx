...
function WorkspaceShell({ renderState }: { renderState: RenderState | null }) {
  ...
  return <ActivePageContext.Provider value={activePage}><>
    ...
    <aside className="sidebar" id="sidebar" role="navigation" aria-label="主导航">
      <div className="sidebar-header">
        ...
        <div><div className="title">AI工作台</div><div className="subtitle">AI Workspace</div></div>
      </div>
      ...
      <div className="menu-scroll">
        <div className="menu-group">
          <div className="menu-group-label">日常管理</div>
          <MenuItem page="dashboard" title="首页" path={<path d="m3 10 9-7 9 7v10a1 1 0 0 1-1 1h-5v-6H9v6H4a1 1 0 0 1-1-1Z" />}>首页</MenuItem>
        ...
        <div className="menu-group">
          <div className="menu-group-label">科研</div>
          <MenuItem page="research-todo" title="待办" path={<><rect x="4" y="4" width="16" height="16" rx="3" /><path d="m8 12 2.5 2.5L16 9" /></>}>待办</MenuItem>
          <MenuItem page="research" title="文献" path={<><path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><path d="M6.5 2H20v19H6.5A2.5 2.5 0 0 1 4 18.5v-14A2.5 2.5 0 0 1 6.5 2Z" /><path d="M8 7h8M8 11h8" /></>}>文献</MenuItem>
          <MenuItem page="research-inspiration" title="科研灵感" path={<path d="M9 18h6M10 22h4M8.1 14.7A7 7 0 1 1 15.9 14.7c-.8.7-1.4 1.6-1.6 2.6H9.7c-.2-1-.8-1.9-1.6-2.6Z" />}>灵感</MenuItem>
        ...
        <div className="menu-group">
          <div className="menu-group-label">生活</div>
        ...
        <div className="menu-group">
          <div className="menu-group-label">内容创作</div>
        ...
        <div className="menu-group">
          <div className="menu-group-label">资讯</div>
          <MenuItem page="news" title="新闻热点" path={<><path d="M4 5h16v14H4z" /><path d="M8 9h8M8 13h8M8 17h5" /></>}>新闻热点</MenuItem>
        </div>

        <div className="menu-group">
          <div className="menu-group-label">系统</div>
          <MenuItem page="settings" title="数据管理" path={<><ellipse cx="12" cy="5" rx="8" ry="3" /><path d="M4 5v7c0 1.7 3.6 3 8 3s8-1.3 8-3V5M4 12v7c0 1.7 3.6 3 8 3s8-1.3 8-3v-7" /></>}>数据管理</MenuItem>
        </div>
      </div>

      <div className="sidebar-footer">
        <button className="theme-toggle" id="themeToggle" aria-label="切换主题" onClick={event => { event.stopPropagation(); workspaceActions.cycleTheme(); }}><span id="themeIcon">🌞</span><span className="tt-label" id="themeLabel">浅色模式</span></button>
        <button className="kbd-hint" id="kbdHelpBtn" title="快捷键帮助" onClick={event => { event.stopPropagation(); workspaceActions.showShortcuts(); }}>?</button>
      </div>
    </aside>
